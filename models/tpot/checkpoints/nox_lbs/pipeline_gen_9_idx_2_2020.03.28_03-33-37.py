...
# Average CV score on the training set was: -871170342.1586899
exported_pipeline = make_pipeline(
    SelectFwe(score_func=f_regression, alpha=0.033),
    SelectPercentile(score_func=f_regression, percentile=95),
    DecisionTreeRegressor(ccp_alpha=100, criterion="mse", max_depth=9, max_features=16, min_samples_leaf=8, min_samples_split=20)
)

...
# Average CV score on the training set was: -477789951.08426934
exported_pipeline = make_pipeline(
    ...
    SelectPercentile(score_func=f_regression, percentile=28),
    DecisionTreeRegressor(ccp_alpha=100, criterion="mse", max_depth=10, max_features=32, min_samples_leaf=10, min_samples_split=14)
)

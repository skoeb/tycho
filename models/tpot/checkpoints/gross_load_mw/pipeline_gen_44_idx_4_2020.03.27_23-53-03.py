...
# Average CV score on the training set was: -485234085.43068707
exported_pipeline = make_pipeline(
    ...
    DecisionTreeRegressor(ccp_alpha=100, criterion="mse", max_depth=10, max_features=32, min_samples_leaf=10, min_samples_split=10)
)
